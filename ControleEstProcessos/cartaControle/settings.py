"""
Django settings for cartaControle project.
...
SECRET_KEY = 'django-insecure-5e6mrnak1=&m43&+h-*0^-&ue-q^=l_-%&zarf*yw9!$y2hf89'
...
ROOT_URLCONF = 'cartaControle.urls'
...
# CORS — Origens permitidas para tunelamento via Ngrok
